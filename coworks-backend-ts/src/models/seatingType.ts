...
class SeatingTypeModel extends Model<SeatingType, SeatingTypeCreationAttributes> implements SeatingType {
  declare id: number;
  declare name: SeatingTypeEnum;
  declare description: string | null;
  declare hourly_rate: number;
  declare daily_rate: number;
  declare weekly_rate: number;
  declare monthly_rate: number;
  declare is_hourly: boolean;
  declare is_daily: boolean;
  declare is_weekly: boolean;
  declare is_monthly: boolean;
  declare min_booking_duration: number;
  declare min_seats: number; // Added new field for minimum seats
  declare short_code: string; // Short code for API calls
  declare capacity_options: number[] | null; // Available capacity options
  declare quantity_options: number[] | null; // Available quantity options for booking multiple units
  declare cost_multiplier: Record<string, number> | null; // Cost multipliers for different quantities
