      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            You're seeing a preview of the dashboard with sample data. Some features may be limited until authentication is restored.
          </Typography>
        </Box>
        
        {/* Show dashboard with mock data */}
        <DashboardStats branchId={userData?.branch_id ? String(userData.branch_id) : undefined} />
      </Container>
    );
  }
