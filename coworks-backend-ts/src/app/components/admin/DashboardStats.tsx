  ...
  const fetchStats = async (retries = 3, delay = 1000) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Properly handle the response based on its structure
        if (response.data.data) {
          ...
          const transformedData = {
            ...
            bookingChange: apiData.bookingChange || 0,
            activeUsers: apiData.activeUsers || 0,
            userChange: apiData.userChange || 0,
            revenue: apiData.revenue || 0,
            revenueChange: apiData.revenueChange || 0,
            occupancyRate: apiData.occupancyRate || 0,
            occupancyChange: apiData.occupancyChange || 0,
            popularSeatingTypes: apiData.popularSeatingTypes || [],
