...
export const formatCurrency = (
  value: number | string | null | undefined | { value: number; formatted: string; currency: string },
  currency: string = 'INR',
  locale: string = 'en-IN'
): string => {
  // Handle the new object format from the API
  if (value !== null && typeof value === 'object' && 'formatted' in value) {
