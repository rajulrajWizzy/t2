...
/**
 * Ensure the end date is set to the last day of the month
 * @param date Date to adjust
 * @returns Date set to the last day of the month
 */
export function setToLastDayOfMonth(date: Date): Date {
 ...
 * 4. End date is always set to the last day of the month
 * 
 * @param startDate Booking start date
 * @param endDate Booking end date (will be adjusted to month end)
...
export function calculateBookingCost(
  ...
  const end = setToLastDayOfMonth(new Date(endDate));
